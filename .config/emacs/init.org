...
#+begin_src emacs-lisp :tangle lisp/email.el
    (setq notmuch-saved-searches
          '((:name "unread" :query "tag:inbox and tag:unread and not tag:deleted")
  ...
  (add-hook 'notmuch-hello-mode-hook
            (lambda ()
              (evil-local-set-key 'normal (kbd "u") (lambda ()
                                                      (interactive)
                                                      (notmuch-search "tag:inbox and tag:unread and not tag:deleted")))
              (evil-local-set-key 'normal (kbd "i") (lambda ()
                                                      (interactive)
