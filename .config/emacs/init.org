    ...
    (let ((left-padding "    "))
      ...
      (insert
       (concat left-padding
               (format "%-27s %6s\n"
                       "🧑‍💻 PR(s) to review:"
                       (notmuch-saved-search-count "folder:Gorgias/Inbox tag:pr_to_review"))))
      (insert
       (concat left-padding
               (format "%-25s %6s\n"
                       "✅ Todo(s):"
...
#+end_src
** Making sure emacs takes 100% window height
#+begin_src emacs-lisp :tangle lisp/appearance.el
           ...
           (
            (tags-todo "+chore"
                       ((org-agenda-overriding-header "🧹 Chore tasks")
                        (org-agenda-skip-function '(org-agenda-skip-entry-if 'habit 'scheduled 'deadline 'timestamp))
...
* Highlighting buffer lines
#+begin_src emacs-lisp :tangle lisp/highlighting-buffer-lines.el
...
#+begin_src emacs-lisp :tangle init.el
  ...
  (load-file (expand-file-name "lisp/highlighting-buffer-lines.el" user-emacs-directory))
#+end_src
