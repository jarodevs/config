...
#+begin_src emacs-lisp :tangle lisp/email.el
  (setq notmuch-saved-searches
        '((:name "Gorgias unread" :query "folder:Gorgias/Inbox tag:inbox and tag:unread and not tag:deleted")
          (:name "Gorgias todo" :query "folder:Gorgias/Inbox tag:todo")
          (:name "Gorgias inbox" :query "folder:Gorgias/Inbox tag:inbox")
          (:name "Proton unread" :query "folder:Proton/Inbox tag:inbox and tag:unread and not tag:deleted")
          (:name "Proton todo" :query "folder:Gorgias/Inbox tag:todo")
          (:name "Proton inbox" :query "folder:Proton/Inbox tag:inbox")))
#+end_src
** Notmuch-hello
#+begin_src emacs-lisp :tangle lisp/email.el
  (add-hook 'notmuch-hello-mode-hook
            (lambda ()
              (evil-local-set-key 'normal (kbd "g u") (lambda ()
                                                      (interactive)
                                                      (notmuch-search "folder:Gorgias/Inbox tag:inbox and tag:unread and not tag:deleted")))
              (evil-local-set-key 'normal (kbd "g i") (lambda ()
                                                      (interactive)
                                                      (notmuch-search "folder:Gorgias/Inbox tag:inbox")))
              (evil-local-set-key 'normal (kbd "p u") (lambda ()
                                                      (interactive)
                                                      (notmuch-search "folder:Proton/Inbox tag:inbox and tag:unread and not tag:deleted")))
              (evil-local-set-key 'normal (kbd "p i") (lambda ()
                                                      (interactive)
                                                      (notmuch-search "folder:Proton/Inbox tag:inbox")))))
#+end_src
** Sending mail - msmtp
#+begin_src emacs-lisp :tangle lisp/email.el
