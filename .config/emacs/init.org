...
#+begin_src emacs-lisp :tangle lisp/org.el
  (org-babel-do-load-languages
   ...
   '((C . t) (emacs-lisp . t))) ;; Enable C and Emacs Lisp
#+end_src
** Org modules
#+begin_src emacs-lisp :tangle lisp/org.el
  (setq org-modules
...
#+end_src
** Setting note when task is rescheduled
#+begin_src emacs-lisp :tangle lisp/org.el
...
**** Defining Gorgias section
#+begin_src emacs-lisp :tangle lisp/email.el
  (defun jarodevs-notmuch-hello-gorgias-section
      ()
    ...
    (let
      ...
      (insert left-padding)
      (insert
       (propertize "Mail account - Gorgias\n" 
                   'face
...
**** Defining Proton section
#+begin_src emacs-lisp :tangle lisp/email.el
  (defun jarodevs-notmuch-hello-personal-section
      ()
    ...
    (let
      ...
      (insert
       (concat "\n" left-padding))
      (insert
       (propertize "Mail account - Personal Proton\n" 
                   'face
                   '(:weight bold :underline t)))
      (insert
       (concat left-padding
...
**** Configuring hello buffer
#+begin_src emacs-lisp :tangle lisp/email.el
  (defun jarodevs-notmuch-hello
      ()
    "Display custom sections in Notmuch Hello buffer while retaining notmuch-hello-mode."
    (interactive)
    (let
        ((buffer
          (get-buffer-create "*Notmuch Dashboard*"))
         (vertical-padding 5))
      (with-current-buffer buffer
        (let
          ...
          (dotimes
              (_ vertical-padding)
            (insert "\n"))
          (jarodevs-notmuch-hello-gorgias-section)
          (jarodevs-notmuch-hello-personal-section)
          (dotimes
              (_ vertical-padding)
            (insert "\n"))
          (read-only-mode 1)))
  ...
  (setq notmuch-show-logo nil
        notmuch-hello-sections '(jarodevs-notmuch-hello))
#+end_src
