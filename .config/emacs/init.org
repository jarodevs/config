...
#+begin_src emacs-lisp :tangle lisp/evil.el
  ...
  (evil-global-set-key 'normal (kbd "g d p") (lambda()
                                               (interactive)
                                               (find-file "~/Documents/org/daily-planner.org")))
#+end_src
* Appearance
** Global ui tweaks
...
TODO 
**** Configuring sections displayed
#+begin_src emacs-lisp :tangle lisp/email.el
