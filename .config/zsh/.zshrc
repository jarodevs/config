...
alias start-ai-agent="launchctl start jarodevs.gorgias.ai-agent && launchctl start jarodevs.gorgias.ai-agent.ngrok"
alias start-helpdesk="cd ~/Gorgias/helpdesk && docker compose up --build -d"
alias start-help-center="cd ~/Gorgias/help-center && docker compose up --build -d"
alias start-helpdesk-web-app="launchctl start jarodevs.gorgias.helpdesk-web-app"
